  ...
  handleAuthFlow = event => {
    ...
    if (this.state.authorized) {
      ...
      axios
        ...
        .then(() => this.props.history.push('/landing', { current_user: { user }, auth: { authToken } } ) )
        .catch(error => {
            console.log(error);
  ...
  render() {
    return (
      <div>
        ...
        <h2>A react app which uses the spotify web api and Genius Api so you can sing along to tracks.</h2>
        <p>
